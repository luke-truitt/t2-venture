...
f = open(dir_path+"\\Full_Diff_48491.txt", "r")
data=f.read()
diff_addr_48491=json.loads(data)
#%%
...
Obj_Input="usa_avm"
#%%
dict_of_48491_ind=dict()
for i in range(len(diff_addr_48491)):
    ad_input=diff_addr_48491[i]['tax_assessor__tax_assessor_id']['address']
    js_output=make_query(time_series_query(ad_input), Obj_Input)
    dict_of_48491_ind[ad_input]=js_output
#%%
raw_48491_ind=json.dumps(dict_of_48491_ind)
text_file = open("Ind_48491.txt", "w")
n = text_file.write(raw_48491_ind)
text_file.close()
#%%
